...
class OutPut():
    ...
    def Show(self):
        ...
        ax = oput.twoDPlot(ax,"x")
        ay = oput.twoDPlot(ay,"y")
        az = oput.twoDPlot(az,"z")
        ...
        ax = oput.vectorTwoDPlot(vf,ax,"x")
        ay = oput.vectorTwoDPlot(vf,ay,"y")
        az = oput.vectorTwoDPlot(vf,az,"z")
        plt.show()
